...
dbfile <- "results/Diallel_runs.sqldb"

{
    m.s  <- c ( rep("d",10), rep("d",10) )
    n.c  <- c ( rep(10, 10), rep(10, 10) )
    f.s  <- c ( rep(25, 10), rep(15, 10) )
...
srt <- c(12, 11, 14, 13, 15, 17, 16, 19, 18, 20)
